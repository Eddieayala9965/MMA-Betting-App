        ...
        <div className="flex flex-col justify-center gap-8 grid grid-cols-1 md:grid-cols-3">
          {filteredOdds.map((item, index) => {
            ...
            return (
              ...
              >
                <div
                  className="absolute inset-0 m-0 h-full w-full overflow-hidden rounded-none bg-transparent bg-[url('/img/UFC.jpeg')] bg-cover bg-clip-border bg-center text-gray-700 shadow-sm"
