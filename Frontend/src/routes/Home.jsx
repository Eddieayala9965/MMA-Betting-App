          ...
          <div className="px-4 sm:px-10 mt-28">
            <div className="max-w-7xl w-full mx-auto">
              <div className="grid md:grid-cols-2 items-center gap-10">
                <div className="max-w-sm w-full rounded-lg shadow-xl border border-grey-200 border-solid border-3 bg-white p-4 md:p-6">
                ...
                <div>
                  ...
                  <p>
                    ...
                    Access up-to-the-minute odds from top bookmakers, track line
                    movements, and analyze historical data to make informed
                    predictions.
                  </p>
